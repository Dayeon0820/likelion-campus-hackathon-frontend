...
const ClassMap = () => {
    ...
    const initializeMap = useCallback(async () => {
        ...
        try {
            ...
            for (let i = 0; i < positions.length; i++) {
                ...
                kakao.maps.event.addListener(marker, 'click', makeOverListener(createdMap, marker, infowindow));
            }
    ...
    useEffect(() => { 
        // 카카오맵 스크립트 읽어오기
        const my_script = new_script('https://dapi.kakao.com/v2/maps/sdk.js?autoload=false&appkey=cfbc506cfb95deee38b8a0c161e4aa81');
    ...
    const moveToJejuCityHall = () => {
        if (map) {
            const jejuCityHallLatLon = new window.kakao.maps.LatLng(33.499621, 126.521954); // 제주 시청의 위도, 경도
